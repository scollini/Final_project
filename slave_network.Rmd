...
ggplot(data = children_1786, aes(x = Farm, y = Percent)) + geom_bar(stat = "identity") + theme(axis.text.x=element_text(angle = 90, hjust = 0)) + ggtitle("Ratio of Children on Mount Vernon Farms in 1786")
...
ggplot(data = children_1799, aes(x = Farm, y = Percent)) + geom_bar(stat = "identity") + theme(axis.text.x=element_text(angle = 90, hjust = 0)) + ggtitle("Ratio of Children on Mount Vernon Farms in 1799")
```
